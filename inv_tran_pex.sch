...
write inv_tran_pex.raw
.endc
"}
C {inv_pex.sym} 490 -120 0 0 {}
C {devices/vdd.sym} 640 -260 0 0 {name=l3 lab=VDD}
C {devices/gnd.sym} 640 -20 0 0 {name=l4 lab=GND}
C {devices/iopin.sym} 660 -120 0 0 {name=p3 lab=Q2}
C {devices/ipin.sym} 100 -140 0 0 {name=p1 lab=A}
C {devices/ipin.sym} 320 -140 0 0 {name=p4 lab=A}
